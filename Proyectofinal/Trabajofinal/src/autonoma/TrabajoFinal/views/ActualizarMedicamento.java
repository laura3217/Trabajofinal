...
public class ActualizarMedicamento extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ActualizarFarmacia
     */
    public ActualizarMedicamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblNombreTienda.setText("Actualizar Medicamento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarMedicamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizarMedicamento dialog = new ActualizarMedicamento(new javax.swing.JFrame(), true);
